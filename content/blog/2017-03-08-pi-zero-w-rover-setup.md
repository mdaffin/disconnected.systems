...
Now you can [finish of]({{< relref
"blog/2016-03-21-raspberry-pi-archlinuxarm-setup.md#cleaning-up" >}}) and [flash
the image to an sd card]({{< relref
"blog/2016-03-21-raspberry-pi-archlinuxarm-setup.md#flash-the-image-to-an-sd-card"
>}}), or simply reboot if your pi if you configure it while it was running.
